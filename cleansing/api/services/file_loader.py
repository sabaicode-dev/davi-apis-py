...
#         # Use the file server path from environment variable if not provided
#         self.server_path = server_path or os.getenv("FILE_SERVER_PATH_FILE")

#     @staticmethod
#     def detect_separator(file_path):
#         """
#         Detects the separator in the file, whether it's ',' or ';'.
#         """
#         try:
#             with open(file_path, 'r', encoding='utf-8') as f:
#                 sample = f.read(1024)
...
#     def load_dataset(self, file_name, chunksize=1000):
#         """
#         Loads dataset from the file in chunks, based on file extension.
#         """
#         extension = file_utils.get_file_extension(file_name)
#         file_path = f"{self.server_path}/{extension}/{file_name}"
