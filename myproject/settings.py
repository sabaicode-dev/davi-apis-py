...
# Debugging loaded environment file
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.getenv('SECRET_KEY', 'fallback-secret-key')  # Use fallback for safety
...
# CORS settings
CORS_ALLOW_CREDENTIALS = True  # Allow cookies and credentials in requests
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', '').split(',')  # Add allowed origins in .env
